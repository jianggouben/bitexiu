 ...
 * Label
 * @Vich\Uploadable
 * @ORM\Table(name="bit_label")
 * @ORM\Entity(repositoryClass="Slackiss\Bundle\BitBundle\Entity\LabelRepository")
 */
class Label
{
     ...
     * @var string
     *
     * @ORM\ManyToOne(targetEntity="LabelType")
     ...
     *                          "image/jpg","image/gif"}
     * )
     * @Vich\UploadableField(mapping="meta", fileNameProperty="image")
     *
     * @var File $image
     */
    private $attach;
